...
describe("findAll", function () {
  ...
  test("filter by min employee", async function (){
  ...
  test("filter by max employee", async function (){
  ...
  test("filter min-max employees", async function (){
  ...
  test("empty list for nothing found", async function(){
...
describe("get", function () {
  test("get company data", async function () {
...
describe("update", function () {
  ...
  test("not found if no such company", async function () {
    try {
      await Company.update("none", updateData);
      fail();
    } catch (err) {
      expect(err instanceof NotFoundError).toBeTruthy();
    }
...
describe("remove", function () {
  test("remove a company", async function () {
